...
public protocol AssistiveChatHostMessagesDelegate : AnyObject {
    ...
    func didTap(chatResult:ChatResult, selectedPlaceSearchResponse:PlaceSearchResponse?, selectedPlaceSearchDetails:PlaceDetailsResponse?, intent:AssistiveChatHost.Intent) async
